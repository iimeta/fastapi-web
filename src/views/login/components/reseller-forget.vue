  ...
  >
    ...
    <a-form-item field="captcha" hide-label>
      <a-input
        ...
        class="reseller-forget-captcha-input"
    ...
    <a-form-item field="password" hide-label class="reseller-forget-password-item">
      <a-input-password
...
<style lang="less" scoped>
  ...
  .login-form {
    ...
    .reseller-forget-captcha-input {
      flex: 1 1;
    }

    .reseller-forget-password-item {
      margin-bottom: 12px;
    }
