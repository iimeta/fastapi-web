  ...
  >
    ...
    <a-form-item field="captcha" hide-label>
      <a-input
        ...
        class="admin-forget-captcha-input"
    ...
    <a-form-item field="password" hide-label class="admin-forget-password-item">
      <a-input-password
...
<style lang="less" scoped>
  ...
  .login-form {
    ...
    .admin-forget-captcha-input {
      flex: 1 1;
    }

    .admin-forget-password-item {
      margin-bottom: 12px;
    }
