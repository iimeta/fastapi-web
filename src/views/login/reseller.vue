  ...
  >
    ...
    <div class="container">
      ...
      <div class="login-card">
        ...
        <Register
          v-if="isRegister"
          :verify-email="sysConfig.reseller_login_register.verify_email"
...
<script lang="ts" setup>
  ...
  import AccountLogin from './components/reseller-account-login.vue';
  import EmailLogin from './components/reseller-email-login.vue';
...
<style lang="less" scoped>
  ...
  @import './style/login-page-shared.less';

  // 登录页共享样式已由 login-page-shared.less 提供
</style>
