export default {
  ...
  'model.placeholder.service_tier': '请选择服务层',
  'model.error.text.required': '请输入服务层、输入和输出价格',
  ...
  'model.label.video': '视频价格',
  'model.error.video.required': '请输入宽度、高度和价格',
  'model.placeholder.video.width': '宽度',
  'model.placeholder.video.height': '高度',
  'model.placeholder.video.once_ratio': '请输入价格',
  ...
  'model.label.video.width_height': '宽度 × 高度',
  'model.label.video.once_ratio': '价格',
