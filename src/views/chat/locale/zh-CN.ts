export default {
  ...
  'chat.detail.label.model_agent_id': '代理ID',
  ...
  'chat.detail.label.total_tokens': '总令牌数',
  'chat.detail.label.status': '状态',
  'chat.detail.label.conn_time': '连接时间',
  'chat.detail.label.duration': '持续时间',
  'chat.detail.label.total_time': '总时间',
  'chat.detail.label.internal_time': '内耗时间',
  ...
  'chat.detail.label.messages': '完整提问',
