...
<script lang="ts" setup>
  ...
  const getSiteConfigDetail = async (
    ...
    try {
      ...
      formData.value.invite_config.reward_quota =
        data.invite_config?.reward_quota;
      formData.value.invite_config.grant_quota =
        data.invite_config?.grant_quota;
      formData.value.invite_config.min_apply_quota =
        data.invite_config?.min_apply_quota;
      formData.value.invite_config.daily_limit =
        data.invite_config?.daily_limit;
      formData.value.invite_config.total_limit =
        data.invite_config?.total_limit;
      formData.value.invite_config.ip_daily_limit =
        data.invite_config?.ip_daily_limit;
      formData.value.invite_config.ip_total_limit =
        data.invite_config?.ip_total_limit;
      formData.value.invite_config.ip_per_inviter_limit =
        data.invite_config?.ip_per_inviter_limit;
      formData.value.invite_config.ip_limit_action =
        data.invite_config?.ip_limit_action || 'silent';
      formData.value.invite_config.rule_text = data.invite_config?.rule_text;
      formData.value.invite_config.invalid_code_action =
        data.invite_config?.invalid_code_action || 'block_register';
      formData.value.invite_config.recharge_rebate_enabled = Boolean(
        data.invite_config?.recharge_rebate_enabled
      );
      formData.value.invite_config.recharge_rebate_first_enabled = Boolean(
        data.invite_config?.recharge_rebate_first_enabled
      );
      formData.value.invite_config.recharge_rebate_first_type =
        data.invite_config?.recharge_rebate_first_type || 'percent';
      formData.value.invite_config.recharge_rebate_first_rate =
        data.invite_config?.recharge_rebate_first_rate;
      formData.value.invite_config.recharge_rebate_first_quota =
        data.invite_config?.recharge_rebate_first_quota;
      formData.value.invite_config.recharge_rebate_second_enabled = Boolean(
        data.invite_config?.recharge_rebate_second_enabled
      );
      formData.value.invite_config.recharge_rebate_second_type =
        data.invite_config?.recharge_rebate_second_type || 'percent';
      formData.value.invite_config.recharge_rebate_second_rate =
        data.invite_config?.recharge_rebate_second_rate;
      formData.value.invite_config.recharge_rebate_second_quota =
        data.invite_config?.recharge_rebate_second_quota;
      ...
      if (!formData.value.apis || formData.value.apis.length === 0) {
        formData.value.apis = [];
        handleApisAdd();
      }
    } catch (err) {
