<template>
  <div class="container">
    <a-breadcrumb class="container-breadcrumb">
      ...
      <a-breadcrumb-item>{{ $t('menu.batch') }}</a-breadcrumb-item>
      <a-breadcrumb-item>{{ $t('menu.batch.list') }}</a-breadcrumb-item>
    </a-breadcrumb>
    <a-card
      class="general-card"
      :bordered="false"
...
<script lang="ts" setup>
  ...
  import { queryBatchPage, BatchPage, BatchPageParams } from '@/api/log';
