    ...
    >
      ...
      >
        ...
        <template #prompt="{ record }">
          <div class="model-cell">
            <div class="model-cell-content">
              <span class="model-cell-line" :title="record.prompt || '-'">
                {{ $t('log.columns.prompt') }}: {{ record.prompt || '-' }}
              </span>
              <span class="model-cell-line" :title="record.size || '-'">
                {{ $t('log.columns.size') }}: {{ record.size || '-' }}
              </span>
            </div>
          </div>
        </template>
...
<script lang="ts" setup>
  ...
  const columns = computed<TableColumnData[]>(() => [
    ...
    },
    {
      ...
      slotName: 'prompt',
      align: 'center',
      cellClass: 'prompt-col',
      headerCellClass: 'prompt-col',
    },
    {
