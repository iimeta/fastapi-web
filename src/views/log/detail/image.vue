  ...
  <div class="log-detail-container">
    ...
    >
      ...
      <a-descriptions-item :label="$t('log.detail.internal_time')">
        ...
        <span v-else>
          <a-tag v-if="currentData.receive_time > 15000" color="red">
            {{ currentData.receive_time }} ms
          </a-tag>
          <a-tag v-else-if="currentData.receive_time > 10000" color="orange">
            {{ currentData.receive_time }} ms
          </a-tag>
          <a-tag v-else-if="currentData.receive_time > 5000" color="gold">
            {{ currentData.receive_time }} ms
          </a-tag>
          <a-tag v-else color="green">
            {{ currentData.receive_time || '-' }} ms
