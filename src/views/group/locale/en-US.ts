export default {
  ...
  'group.label.is_enable_image_size_check': 'Strict Image Size Check',
  'group.label.image_size_check_retry': 'Retry Count',
  'group.placeholder.image_size_check_retry': 'Empty or 0 means follow the system error retry count',
  'group.detail.image_size_check_retry_follow': 'Follow system',
