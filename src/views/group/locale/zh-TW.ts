export default {
  ...
  'group.label.is_enable_image_size_check': '圖像尺寸強校驗',
  'group.label.image_size_check_retry': '重試次數',
  'group.placeholder.image_size_check_retry': '空或 0 表示跟隨系統配置的錯誤重試次數',
  'group.detail.image_size_check_retry_follow': '跟隨系統',
