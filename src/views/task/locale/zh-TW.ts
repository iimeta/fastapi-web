export default {
  ...
  'task.detail.image': '圖像',
  'task.detail.image_id': '圖像ID',
  'task.detail.job_id': '上游任務ID',
  'task.detail.n': '張數',
  'task.detail.quality': '品質',
  'task.detail.size': '解析度',
  'task.detail.output_format': '輸出格式',
  ...
  'task.button.regenerate.confirm': '確定要重新生成該任務嗎? 將把任務狀態重置為排隊中並重新執行',
  'task.button.batch.regenerate.confirm': '是否確定重新生成所選的{count}條數據? 將把任務狀態重置為排隊中並重新執行',
};
