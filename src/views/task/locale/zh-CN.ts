export default {
  ...
  // columns
  'task.columns.total_time': '总耗时',
  'task.columns.tooltip.total_time': '从创建任务到完成所用的时长, 单位: ms(毫秒)',
  // detail
  ...
  'task.detail.output_format': '输出格式',
  ...
  'task.detail.input_file_paths': '输入文件路径',
