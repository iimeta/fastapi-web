<template>
  <div class="container">
    <a-breadcrumb class="container-breadcrumb">
      ...
      <a-breadcrumb-item>{{ $t('task.menu.image') }}</a-breadcrumb-item>
    </a-breadcrumb>
    <a-card
      class="general-card"
      :bordered="false"
    ...
    >
      <a-row>
              ...
              <a-col :span="8">
                ...
                >
                  <a-input
                    ...
                    :placeholder="$t('task.form.placeholder.image_id')"
                    allow-clear
                  />
                </a-form-item>
              </a-col>
              <a-col :span="8">
                ...
                >
                  <a-input
                    ...
                    :placeholder="$t('task.form.placeholder.image_url')"
                    allow-clear
                  />
                </a-form-item>
              </a-col>
        ...
        <a-divider
          class="task-image-list-search-divider"
          direction="vertical"
        />
        <a-col :flex="'86px'" class="task-image-list-search-actions">
              ...
              <template #content>
                <div id="tableSetting">
                  <div
                    ...
                    class="setting"
                  >
                    <div class="task-image-list-drag-handle">
                      <icon-drag-arrow />
                    </div>
                    <div>
                      <a-checkbox
      ...
      <a-drawer
        :title="$t('task.menu.image.detail')"
        unmount-on-close
        render-to-body
        :width="700"
        :footer="false"
...
<style scoped lang="less">
  ...
  .task-image-list-search-divider {
    height: 84px;
  }

  .task-image-list-search-actions {
    text-align: right;
  }

  .task-image-list-toolbar-divider {
    margin-top: 0;
    margin-bottom: 16px;
  }

  .task-image-list-toolbar-row {
    margin-bottom: 16px;
  }

  .task-image-list-table-actions {
    display: flex;
    height: 32px;
    align-items: center;
    justify-content: end;
