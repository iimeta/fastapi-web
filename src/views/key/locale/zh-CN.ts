export default {
  ...
  'key.label.provider': '公司',
  'key.placeholder.provider': '选择公司',
  'key.error.provider.required': '请选择公司',
  'key.label.key': '密钥',
