export default {
  ...
  'key.placeholder.update.key': '请输入密钥, 如: sk-aaa',
  'key.placeholder.update.key.baidu': '请输入密钥, 如: client_id丨client_secret',
  'key.placeholder.update.key.xfyun': '请输入密钥, 如: APPID丨APISecret丨APIKey',
