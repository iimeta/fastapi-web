  ...
  <div class="container">
    ...
    >
      <a-row v-permission="['reseller', 'admin']">
              ...
              <a-col :span="8">
                ...
                >
                  <a-range-picker
                    ...
                    class="finance-bill-list-full-width"
                  />
                </a-form-item>
              </a-col>
            </a-row>
        ...
        <a-divider
          class="finance-bill-list-search-divider"
          direction="vertical"
        />
        <a-col :flex="'86px'" class="finance-bill-list-search-actions">
      ...
      <a-divider
        ...
        class="finance-bill-list-toolbar-divider"
      />
      <a-row class="finance-bill-list-toolbar-row">
        ...
        <a-col :span="12" class="finance-bill-list-table-actions">
              ...
              <template #content>
                <div id="tableSetting">
                  <div
                    ...
                    class="setting"
                  >
                    <div class="finance-bill-list-drag-handle">
                      <icon-drag-arrow />
                    </div>
                    <div>
                      <a-checkbox
...
<style scoped lang="less">
  ...
  .finance-bill-list-full-width {
    width: 100%;
  }

  .finance-bill-list-search-divider {
    height: 32px;
  }

  .finance-bill-list-search-actions {
    text-align: right;
  }

  .finance-bill-list-toolbar-divider {
    margin-top: 0;
    margin-bottom: 16px;
  }

  .finance-bill-list-toolbar-row {
    margin-bottom: 16px;
  }

  .finance-bill-list-table-actions {
    display: flex;
    height: 32px;
    align-items: center;
    justify-content: end;
