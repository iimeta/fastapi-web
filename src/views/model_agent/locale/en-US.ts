export default {
  ...
  'model.agent.label.session_keep_fail_ttl': 'Failure Record Duration',
  'model.agent.label.session_keep_switch_threshold': 'Switch Threshold',
  'model.agent.label.session_keep_user_limit': 'Per-User Limit',
  'model.agent.label.session_keep_agent_limit': 'Per-Agent Limit',
  'model.agent.label.session_keep_global_limit': 'Global Total Limit',
  'model.agent.label.session_keep_count': 'Session Keep Cache Count',
  'model.agent.placeholder.session_keep_ttl': 'Please enter session keep duration',
  'model.agent.placeholder.session_keep_fail_ttl': 'Please enter failure record duration',
  'model.agent.placeholder.session_keep_switch_threshold': 'Please enter switch threshold',
  'model.agent.placeholder.session_keep_user_limit': 'Please enter per-user limit',
  'model.agent.placeholder.session_keep_agent_limit': 'Please enter per-agent limit',
  'model.agent.placeholder.session_keep_global_limit': 'Please enter global total limit',
};
