export default {
  ...
  'model.agent.label.session_keep_fail_ttl': '失敗記錄保持時長',
  'model.agent.label.session_keep_switch_threshold': '切換閾值',
  'model.agent.label.session_keep_user_limit': '單用戶上限',
  'model.agent.label.session_keep_agent_limit': '單代理上限',
  'model.agent.label.session_keep_global_limit': '全局總上限',
  'model.agent.label.session_keep_count': '會話保持快取數量',
  'model.agent.placeholder.session_keep_ttl': '請輸入會話保持時長',
  'model.agent.placeholder.session_keep_fail_ttl': '請輸入失敗記錄保持時長',
  'model.agent.placeholder.session_keep_switch_threshold': '請輸入切換閾值',
  'model.agent.placeholder.session_keep_user_limit': '請輸入單用戶上限',
  'model.agent.placeholder.session_keep_agent_limit': '請輸入單代理上限',
  'model.agent.placeholder.session_keep_global_limit': '請輸入全局總上限',
};
