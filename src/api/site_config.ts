...
export interface SiteConfigCreate {
  ...
  invite_reward_quota: any;
  invitee_grant_quota: any;
  ...
  invite_recharge_rebate_first_rate: any;
  invite_recharge_rebate_first_quota: any;
  invite_recharge_rebate_second_enabled: boolean;
  invite_recharge_rebate_second_type: string;
  invite_recharge_rebate_second_rate: any;
  invite_recharge_rebate_second_quota: any;
